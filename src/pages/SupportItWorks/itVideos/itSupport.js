  ...
  <div className="col-md-3">
    <div className="card">
      <div className="card-body text-center">
        ...
        <p className="card-text text-center">We will design responsive website in 10 hours.
